...
if !exists('s:doneMappings')
	...
	call IMAP ('EXY', "\\xymatrix{\<CR><++>\<CR>}<++>", "tex")   " Added by Ray
	call IMAP ('__', '_{<++>}<++>', "tex")
	call IMAP ('()', '(<++>)<++>', "tex")
	call IMAP ('[]', '[<++>]<++>', "tex")
	call IMAP ('{}', '{<++>}<++>', "tex")
	...
	call IMAP (g:Tex_Leader.'1', '^{-1}', "tex")
	call IMAP (g:Tex_Leader.'3', '\#', "tex")
  ...
  call IMAP('\oA', '\overline{A}', 'tex')
  call IMAP('\oB', '\overline{B}', 'tex')
  call IMAP('\oC', '\overline{C}', 'tex')
  call IMAP('\oD', '\overline{D}', 'tex')
  call IMAP('\oE', '\overline{E}', 'tex')
  call IMAP('\oF', '\overline{F}', 'tex')
  call IMAP('\oG', '\overline{G}', 'tex')
  call IMAP('\oH', '\overline{H}', 'tex')
  call IMAP('\oI', '\overline{I}', 'tex')
  call IMAP('\oJ', '\overline{J}', 'tex')
  call IMAP('\oK', '\overline{K}', 'tex')
  call IMAP('\oL', '\overline{L}', 'tex')
  call IMAP('\oM', '\overline{M}', 'tex')
  call IMAP('\oN', '\overline{N}', 'tex')
  call IMAP('\oO', '\overline{O}', 'tex')
  call IMAP('\oP', '\overline{P}', 'tex')
  call IMAP('\oQ', '\overline{Q}', 'tex')
  call IMAP('\oR', '\overline{R}', 'tex')
  call IMAP('\oS', '\overline{S}', 'tex')
  call IMAP('\oT', '\overline{T}', 'tex')
  call IMAP('\oU', '\overline{U}', 'tex')
  call IMAP('\oV', '\overline{V}', 'tex')
  call IMAP('\oW', '\overline{W}', 'tex')
  call IMAP('\oX', '\overline{X}', 'tex')
  call IMAP('\oY', '\overline{Y}', 'tex')
  call IMAP('\oZ', '\overline{Z}', 'tex')
  ...
  call IMAP('\cD', '\mathcal{D}', 'tex')
  call IMAP('\cE', '\mathcal{E}', 'tex')
  call IMAP('\cF', '\mathcal{F}', 'tex')
  call IMAP('\cG', '\mathcal{G}', 'tex')
  call IMAP('\cH', '\mathcal{H}', 'tex')
  call IMAP('\cI', '\mathcal{I}', 'tex')
  call IMAP('\cJ', '\mathcal{J}', 'tex')
  call IMAP('\cK', '\mathcal{K}', 'tex')
  call IMAP('\cL', '\mathcal{L}', 'tex')
  call IMAP('\cM', '\mathcal{M}', 'tex')
  call IMAP('\cN', '\mathcal{N}', 'tex')
  call IMAP('\cO', '\mathcal{O}', 'tex')
  call IMAP('\cP', '\mathcal{P}', 'tex')
  call IMAP('\cQ', '\mathcal{Q}', 'tex')
  call IMAP('\cR', '\mathcal{R}', 'tex')
  call IMAP('\cS', '\mathcal{S}', 'tex')
  call IMAP('\cT', '\mathcal{T}', 'tex')
  call IMAP('\cU', '\mathcal{U}', 'tex')
  call IMAP('\cV', '\mathcal{V}', 'tex')
  call IMAP('\cW', '\mathcal{W}', 'tex')
  call IMAP('\cX', '\mathcal{X}', 'tex')
  call IMAP('\cY', '\mathcal{Y}', 'tex')
  call IMAP('\cZ', '\mathcal{Z}', 'tex')
  call IMAP(g:Tex_Leader.'CA', '\mathcal{A}', 'tex')
  call IMAP(g:Tex_Leader.'CB', '\mathcal{B}', 'tex')
  call IMAP(g:Tex_Leader.'CC', '\mathcal{C}', 'tex')
  call IMAP(g:Tex_Leader.'CD', '\mathcal{D}', 'tex')
  call IMAP(g:Tex_Leader.'CE', '\mathcal{E}', 'tex')
  call IMAP(g:Tex_Leader.'CF', '\mathcal{F}', 'tex')
  call IMAP(g:Tex_Leader.'CG', '\mathcal{G}', 'tex')
  call IMAP(g:Tex_Leader.'CH', '\mathcal{H}', 'tex')
  call IMAP(g:Tex_Leader.'CI', '\mathcal{I}', 'tex')
  call IMAP(g:Tex_Leader.'CJ', '\mathcal{J}', 'tex')
  call IMAP(g:Tex_Leader.'CK', '\mathcal{K}', 'tex')
  call IMAP(g:Tex_Leader.'CL', '\mathcal{L}', 'tex')
  call IMAP(g:Tex_Leader.'CM', '\mathcal{M}', 'tex')
  call IMAP(g:Tex_Leader.'CN', '\mathcal{N}', 'tex')
  call IMAP(g:Tex_Leader.'CO', '\mathcal{O}', 'tex')
  call IMAP(g:Tex_Leader.'CP', '\mathcal{P}', 'tex')
  call IMAP(g:Tex_Leader.'CQ', '\mathcal{Q}', 'tex')
  call IMAP(g:Tex_Leader.'CR', '\mathcal{R}', 'tex')
  call IMAP(g:Tex_Leader.'CS', '\mathcal{S}', 'tex')
  call IMAP(g:Tex_Leader.'CT', '\mathcal{T}', 'tex')
  call IMAP(g:Tex_Leader.'CU', '\mathcal{U}', 'tex')
  call IMAP(g:Tex_Leader.'CV', '\mathcal{V}', 'tex')
  call IMAP(g:Tex_Leader.'CW', '\mathcal{W}', 'tex')
  call IMAP(g:Tex_Leader.'CX', '\mathcal{X}', 'tex')
  call IMAP(g:Tex_Leader.'CY', '\mathcal{Y}', 'tex')
  call IMAP(g:Tex_Leader.'CZ', '\mathcal{Z}', 'tex')
	" }}}
