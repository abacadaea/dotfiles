...
" }}}
	...
	"exec 'vnoremap <silent> '.g:Tex_Leader."l[ <Esc>/[<Cr>Nv%h\<C-\\>\<C-N>:call VEnclose('\\left', ' \\right', '\\left', '\\right')\<CR>"
	"exec 'inoremap <silent> '.g:Tex_Leader."[ <Esc>/[<Cr>Nv%h\<C-\\>\<C-N>:call VEnclose('\\left', ' \\right', '\\left', '\\right')\<CR>"
	"exec "inoremap <silent> ".g:Tex_Leader."( <Esc>/(<Cr>Nv%h\<C-\\>\<C-N>:call VEnclose('\\left', ' \\right', '\\left', '\\right')\<CR>"
	"exec "inoremap <silent> ".g:Tex_Leader."{ <Esc>/\\{<Cr>Nvl%hh\<C-\\>\<C-N>:call VEnclose('\\left', ' \\right', '\\left', '\\right')\<CR>"
" ==============================================================================
