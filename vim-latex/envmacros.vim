...
" Ray's macros
call s:Tex_EnvMacros('TTH', '&Theorem.',  'theorem')
call s:Tex_EnvMacros('TEX', '&Theorem.',  'example')
call s:Tex_EnvMacros('TPF', '&Theorem.',  'proof')
call s:Tex_EnvMacros('TLE', '&Theorem.',  'lemma')
call s:Tex_EnvMacros('TFA', '&Theorem.',  'fact')
call s:Tex_EnvMacros('TQU', '&Theorem.',  'question')
call s:Tex_EnvMacros('TDE', '&Theorem.',  'definition')
...
call s:Tex_EnvMacros('claim*', '&Theorem.',  'claim*')
call s:Tex_EnvMacros('lemma*', '&Theorem.',  'lemma*')
call s:Tex_EnvMacros('fact*', '&Theorem.',  'fact*')
call s:Tex_EnvMacros('question*', '&Theorem.',  'question*')
